...
RSpec.describe RubyLLMCLI::Config do
  ...
  describe "#workspace" do
    it "returns a workspace instance" do
      expect(config.workspace).to be_a(RubyLLMCLI::Workspace)
  ...
  describe "#memory" do
    it "returns a memory instance when enabled" do
      ...
      expect(config.memory).to be_a(RubyLLMCLI::Memory)
    end
  ...
  describe "#save" do
    it "saves configuration to file" do
      ...
      saved_config = YAML.load_file(RubyLLMCLI::Config::CONFIG_FILE)
