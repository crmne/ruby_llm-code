...
Gem::Specification.new do |spec|
  ...
  spec.description = 'RubyLLM Code will provide an AI-powered coding assistant. This is a placeholder release - full implementation coming soon!' # rubocop:disable Layout/LineLength
