  ...
  module Code
    module Tools
      ...
      class ListDirectory < BaseTool
        ...
        def execute(path:, ignore: []) # rubocop:disable Metrics/PerceivedComplexity
          ...
          entries.each do |entry|
            ...
            next if workspace.ignored?(full_path)
          ...
          (dirs + files).each do |entry|
            ...
            if File.directory?(full_path)
              ...
              sub_entries.each do |sub|
                ...
                output << if File.directory?(sub_path)
                            "    - #{sub}/"
                          else
                            "    - #{sub}"
                          end
