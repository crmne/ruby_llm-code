...
require 'spec_helper'
# rubocop:disable RSpec/MultipleDescribes, RSpec/InstanceVariable
...
RSpec.describe RubyLLM::Code::GitIgnore do
...
# rubocop:enable RSpec/MultipleDescribes, RSpec/InstanceVariable
